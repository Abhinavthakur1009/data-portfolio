...
const Footer = () => {
  ...
  const titleChars = "ABHINAV.".split("");

  const Social = [
    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/abhinav-thakur-141037383/' },
    { name: 'GitHub', url: 'https://github.com/Abhinavthakur1009' },
    { name: 'Instagram', url: 'https://www.instagram.com/abhi._.rajput._10/' }
  ]
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/30 text-sm">
            © {new Date().getFullYear()} Abhinav Thakur. All Rights Reserved.
          </p>
