    ...
    const experiences = [
        {
            ...
            description: 'Intensive training in data analysis tools and techniques, including Python, SQL, Power BI, and Tableau.',
        },
        {
            company: 'MCM DAV COLLEGE KANGRA(HP)',
            role: 'Bachelor of Computer Application',
            period: '2022 - 2025',
            description: 'CGPA: 7.52',
        },
        {
            company: "GOVT. SCHOOL HARIPUR(HP)",
            role: "12th Grade",
            period: "2021 - 2022",
