...
import {
  faDatabase, faCode, faTerminal, faCube, faNetworkWired, faLayerGroup
} from '@fortawesome/free-solid-svg-icons';

const TechStack = () => {
  const techItems = [
    { icon: faPython, label: "Python", color: '#3776AB' },
    { icon: faDatabase, label: "Pandas", color: '#150458' },
    { icon: faCode, label: "Excel", color: '#217346' },
    { icon: faCube, label: "PowerBI", color: '#F2C811' },
    { icon: faCode, label: "Numpy", color: '#013243' },
    { icon: faTerminal, label: "Matplotlib", color: '#ffffff' },
    { icon: faDatabase, label: "MySQL", color: '#4479A1' },
    { icon: faLayerGroup, label: "Tableau", color: '#E97627' },
  ];
