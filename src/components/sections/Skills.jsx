...
const Skills = () => {
  ...
  const skills = useMemo(() => [
    { name: "Python", icon: faPython, x: 20, y: 30, z: 20, color: "#3776AB" },
    { name: "Pandas", icon: faDatabase, x: 75, y: 25, z: 10, color: "#150458" },
    { name: "Excel", icon: faCode, x: 45, y: 45, z: 30, color: "#217346" },
    { name: "PowerBI", icon: faLayerGroup, x: 15, y: 70, z: 15, color: "#F2C811" },
    { name: "Numpy", icon: faCode, x: 85, y: 75, z: 25, color: "#013243" },
    { name: "Matplotlib", icon: faCode, x: 60, y: 60, z: 5, color: "#ffffff" },
    { name: "MySQL", icon: faDatabase, x: 30, y: 80, z: 10, color: "#4479A1" },
    { name: "Tableau", icon: faLayerGroup, x: 50, y: 15, z: 25, color: "#E97627" }
  ], []);
