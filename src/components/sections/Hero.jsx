  ...
  return (
    ...
    >
      ...
      <div className="text-center px-6 z-10 relative">
        ...
        >
          Dedicated to transforming complex data into actionable insights that drive business growth and process improvement.
        </motion.p>
