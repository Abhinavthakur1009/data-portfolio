...
import profileImg from "../../assets/abhinav.jpeg";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto font-light">
            Entry-Level Data Analyst with a strong technical background.
          </p>
        </motion.div>
              ...
              <Magnetic strength={0.2}>
                <div className="relative rounded-3xl overflow-hidden border border-white/10 group h-full cursor-none">
                  ...
                  <div className="absolute bottom-6 left-6">
                    <h3 className="text-3xl font-bold text-white mb-1">Abhinav Thakur</h3>
                    <p className="text-white/60 font-mono text-sm">Data Analyst</p>
                    <p className="text-white/50 text-xs mt-2">Chandigarh, India</p>
                  </div>
                </div>
              </Magnetic>
            </Tilt>
            ...
            <Tilt className="h-full">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col justify-center h-full hover:bg-white/10 transition-colors duration-300">
                ...
                <p className="text-white/70 leading-relaxed font-light text-lg">
                  I'm an Entry-Level Data Analyst with a strong technical background in Python, SQL, and Excel.
                  Experienced in the full data lifecycle, from managing databases with MySQL to building
                  interactive dashboards in Power BI and Tableau. I am dedicated to transforming complex
          ...
          >
            <Tilt className="h-full">
              <div className="bg-[#0f0f0f] border border-white/10 rounded-3xl p-6 flex flex-col items-center justify-center h-full hover:border-white/30 transition-colors">
                ...
                <span className="text-white/50 text-sm uppercase tracking-wider">Scale Projects</span>
              </div>
            </Tilt>
          </motion.div>
