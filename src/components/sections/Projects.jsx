...
import student from '../../assets/SMS.png'
...
const Projects = ({ selectedProject, setSelectedProject }) => {
  const projectData = [
    {
      image: sales,
      title: "Sales Performance & Customer Distribution Dashboard",
    ...
    },
    {
      ...
      description: "Developed a desktop-based Student Management System using Python and Tkinter for the user interface and MySQL for database management. Implemented CRUD operations to add, search, update, display, and delete student records.",
    ...
    {
      image: instagram,
      title: "Instagram-Inspired Login & Authentication System",
      description: "Developed a secure user login system with registration and password reset features using Python and Tkinter. Integrated MySQL for data storage and implemented password encryption using Bcrypt.",
      tech: ["Python", "Tkinter", "MySQL", "Bcrypt"],
      link: "https://github.com/Abhinavthakur1009/instagram-login.git",
      accentColor: '#E1306C'
    },
    {
      image: car,
      title: "Car Vault – Collection Management",
      description: "A Python desktop application for managing car collections with MySQL integration. Features CRUD operations, unique validation, and Matplotlib-based brand analytics.",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-6xl md:text-9xl font-black text-white tracking-tighter leading-none">
            SELECTED<br />
            <span className="text-transparent stroke-text" style={{ WebkitTextStrokeColor: 'var(--accent-glow)' }}>PROJECTS</span>
          </h2>
        </motion.div>
